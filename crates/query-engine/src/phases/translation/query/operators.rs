...
fn lookup_by_name(name: &str) -> Option<sql::ast::BinaryOperator> {
    match name {
        "eq" => Some(sql::ast::BinaryOperator::Equals),
        "neq" => Some(sql::ast::BinaryOperator::NotEquals),
        "lt" => Some(sql::ast::BinaryOperator::LessThan),
        "lte" => Some(sql::ast::BinaryOperator::LessThanOrEqualTo),
        "gt" => Some(sql::ast::BinaryOperator::GreaterThan),
        "gte" => Some(sql::ast::BinaryOperator::GreaterThanOrEqualTo),
        "like" => Some(sql::ast::BinaryOperator::Like),
        "nlike" => Some(sql::ast::BinaryOperator::NotLike),
        "ilike" => Some(sql::ast::BinaryOperator::CaseInsensitiveLike),
        "nilike" => Some(sql::ast::BinaryOperator::NotCaseInsensitiveLike),
        "similar" => Some(sql::ast::BinaryOperator::Similar),
        "nsimilar" => Some(sql::ast::BinaryOperator::NotSimilar),
        "regex" => Some(sql::ast::BinaryOperator::Regex),
        "nregex" => Some(sql::ast::BinaryOperator::NotRegex),
        "iregex" => Some(sql::ast::BinaryOperator::CaseInsensitiveRegex),
        "niregex" => Some(sql::ast::BinaryOperator::NotCaseInsensitiveRegex),
        _ => None,
    }
}
