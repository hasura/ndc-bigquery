...
#[tokio::test]
async fn it_converts_select_no_fields() {
    let result = common::test_translation("select_no_fields").await.unwrap();
    insta::assert_snapshot!(result);
}
...
//     let result = common::test_translation("select_where_related_exists").await.unwrap();
//     insta::assert_snapshot!(result);
// }
...
//     let result = common::test_translation("simple_array_relationship").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn it_simple_object_relationship() {
//     let result = common::test_translation("simple_object_relationship").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn nested_array_relationships() {
//     let result = common::test_translation("nested_array_relationships").await.unwrap();
//     insta::assert_snapshot!(result);
// }
...
//     let result = common::test_translation("dup_array_relationship").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn nested_recursive_relationship() {
//     let result = common::test_translation("nested_recursive_relationship").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn very_nested_recursive_relationship() {
//     let result = common::test_translation("very_nested_recursive_relationship").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn sorting_by_relationship_column() {
//     let result = common::test_translation("sorting_by_relationship_column").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn sorting_by_nested_relationship_column() {
//     let result = common::test_translation("sorting_by_nested_relationship_column").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn sorting_by_recursive_relationship_column() {
//     let result = common::test_translation("sorting_by_recursive_relationship_column").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn sorting_by_relationship_count() {
//     let result = common::test_translation("sorting_by_relationship_count").await.unwrap();
//     insta::assert_snapshot!(result);
// }

// #[tokio::test]
// async fn sorting_by_nested_relationship_count() {
//     let result = common::test_translation("sorting_by_nested_relationship_count").await.unwrap();
//     insta::assert_snapshot!(result);
// }
...
//         let result = common::test_translation("native_queries/select_artist").await.unwrap();
//         insta::assert_snapshot!(result);
//     }

//     #[tokio::test]
//     async fn select_artist_by_id() {
//         let result = common::test_translation("native_queries/select_artist_by_id").await.unwrap();
//         insta::assert_snapshot!(result);
//     }

//     #[tokio::test]
//     async fn select_artist_by_name() {
//         let result = common::test_translation("native_queries/select_artist_by_name").await.unwrap();
//         insta::assert_snapshot!(result);
//     }
...
//         let result =
//             common::test_translation("native_queries/select_artist_with_album_by_title").await.unwrap();
//         insta::assert_snapshot!(result);
//     }
...
mod types {
    ...
    //     let result = common::test_translation("values/select_types_on_native_queries").await.unwrap();
    //     insta::assert_snapshot!(result);
    // }
}
