...
-- TODO: We derive all the information from the `hasura-development.chinook_sample.INFORMATION_SCHEMA`. Sadly, not
...
from
  (
            ...
            (
              select
                json_object(
                  ...
                  (
                    select array_agg(cc.column_name)
                    from hasura-development.chinook_sample.INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE cc
                    where
                ...
                json_object(
                  ...
                  json_object(
                    ...
                    (
                      ...
                      from hasura-development.chinook_sample.INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE as tu --
                      where
                    ...
                    (
                      select
                        json_object(fc.column_name, uc.column_name)
                      from hasura-development.chinook_sample.INFORMATION_SCHEMA.KEY_COLUMN_USAGE as fc
                      join hasura-development.chinook_sample.INFORMATION_SCHEMA.KEY_COLUMN_USAGE as uc
    ...
    from hasura-development.chinook_sample.INFORMATION_SCHEMA.TABLES as t
      ...
      (
        ...
        from
          (
            ...
            from hasura-development.chinook_sample.INFORMATION_SCHEMA.ROUTINES as r
          ) as r
        -- get the parameters count for a routine
        left outer join UNNEST (
          (select count(*) as count
            from hasura-development.chinook_sample.INFORMATION_SCHEMA.PARAMETERS parameters
